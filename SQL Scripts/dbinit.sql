...
CREATE TABLE employee (employee_id int(6)  AUTO_INCREMENT, first_name VARCHAR(20) NOT NULL, last_name VARCHAR(20) NOT NULL, address_1 VARCHAR(50) NOT NULL, address_2 VARCHAR(30), city VARCHAR(30) NOT NULL, postcode VARCHAR(8) NOT NULL, national_insurance VARCHAR(9) NOT NULL, bank_account VARCHAR(34) NOT NULL, salary decimal(11,2) NOT NULL,PRIMARY KEY(employee_id));
...
INSERT INTO bu (name, directorid) VALUES ('Evolve', 43), ('Gov', 56), ('Enterprise', 31), ('Smart', 3), ('Corporate', 84);
...
insert into emp_bu values (49,2);		
...
insert into emp_bu values (61,1);		
...
insert into emp_bu values (93,4);		
