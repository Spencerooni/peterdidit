...
CREATE TABLE sales(sales_id int(6) AUTO_INCREMENT, commission_rate decimal(5,4) NOT NULL, total_sales int(5) NOT NULL, PRIMARY KEY(sales_id));
...
salary decimal(11,2) NOT NULL, sales_id int(6), PRIMARY KEY(employee_id), FOREIGN KEY (sales_id) REFERENCES sales(sales_id));
...
INSERT INTO sales (commission_rate,total_sales)VALUES (0.1287, 400);
INSERT INTO sales (commission_rate,total_sales)VALUES (0.0762, 350);
INSERT INTO sales (commission_rate,total_sales)VALUES (0.1983, 1800);
INSERT INTO sales (commission_rate,total_sales)VALUES (0.21, 3100);
INSERT INTO sales (commission_rate,total_sales)VALUES (0.115, 9800);
INSERT INTO sales (commission_rate,total_sales)VALUES (0.1342, 7800);
...
INSERT INTO employee (first_name, last_name, address_1, city, postcode, national_insurance,bank_account,salary, sales_id) VALUES ("Kole","Sampson","7455 lawler","Allentown","18158","2JTWOQ7CA","4917897156790480",610908, 1);
...
INSERT INTO employee (first_name, last_name, address_1, city, postcode, national_insurance,bank_account,salary, sales_id) VALUES ("Jessie","Rivera","59 grover","New York","10960","YW293DID8","6762166152635128",143264, 2);
...
INSERT INTO employee (first_name, last_name, address_1, city, postcode, national_insurance,bank_account,salary, sales_id) VALUES ("Barrett","Briggs","627 potawatomie","Peoria","61507","C6VUMX2Y0","6390464805344762",627354, 5);
...
INSERT INTO employee (first_name, last_name, address_1, city, postcode, national_insurance,bank_account,salary, sales_id) VALUES ("Jolie","Stafford","8824 103rd","Sioux Falls","57020","YE70KBQGM","5450394742942734",973267, 3);
...
INSERT INTO employee (first_name, last_name, address_1, city, postcode, national_insurance,bank_account,salary, sales_id) VALUES ("Hayden","Beach","9187 bishop ford i57","Hartford","06128","V19WY8UXR","5294795392053392",734045, 6);
...
INSERT INTO employee (first_name, last_name, address_1, city, postcode, national_insurance,bank_account,salary, sales_id) VALUES ("Aniya","Gutierrez","6081 dr martin luther king jr","Rockford","61168","BY6ZE5BG9","6557857161769440",570940, 4);
